"""Classification post-processing and skill-selection refresh helpers."""
...
def apply_fallback_labels(
    ...
    *,
    ...
    """
    classify_tokens = 0
    # Only bill classify tokens when classification produced usable labels.
...
def refresh_matched(
    ...
    *,
    ...
    WR-01: guardrail_keys are bundle/filename keys force-loaded on every call.
    """
    packed_paths = [f.path for f in packed_files]
    diff_text = "\n".join(f.patch or "" for f in packed_files)

...
- [ ] **Phase 1: Walking Skeleton Review Loop** - End-to-end PR review: fetch diff via API, Copilot CLI review, sticky summary comment, secure trigger posture
...
|-------|----------------|--------|-----------|
| 1. Walking Skeleton Review Loop | 0/TBD | Not started | - |
| 2. Zero-Token Classification & Routing | 0/TBD | Not started | - |
